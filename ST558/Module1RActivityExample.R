...
# Module 1 R Activity Example Script File
...
setwd('/Users/scemerson/Documents/Old Computer Documents/ST 558 2017/Module 1')
...
# We can also control how many digits are displayed in the output using the
